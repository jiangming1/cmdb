...
<body>
	<input id="pubkeyInput" type="hidden" value="${pubkey }" />
	<div><img src="img/llb_reg_top.png" style="width: 100%;" /></div>
	<div class="reg-content">
		<div class="reg-form">
			<div class="form-row form-row_llb" style="padding-top: 10%;">
				...
				<input type="text" class="input1 form-control" placeholder="请输入图形验证码" id="picVerifyCodeInput" />
					<div style="margin-top: -30px; float:right;width:43%">
						<img id="imgVerifyCode" style="height: 29px;" />
						<a id="btnRefreshPicVerifyCode"> 看不清?</a>
					</div>					
				</div>
			</div>
			<div class="form-row" style="clear:both;height:40px;">
	...
	<div class="aboutus-title">
		<img src="img/llb_reg_aboutus.png" />
	</div>
	...
	<script src="llb_regist.js"></script>
