...
<body>
<div class="contain">
	<img src="http://laicunba.b0.upaiyun.com/lcb/activity/heavy_snow_bg.jpg" width="100%" />
	<div class="button">
		<img src="http://laicunba.b0.upaiyun.com/lcb/activity/heavy_snow_btn.png" width="75%" />
	</div>
</div>
...
$(".button").click(function(){
	...
	$.post("heavy_snow_go_invite.htm", param, function(data) {
