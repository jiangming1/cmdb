     	...
     	<c:forEach items="${memberList }" var="member" varStatus="status">
     		<c:if test="${status.index==0}">
				<tr>
					...
					<td style="width: 60%; text-align: center;">${fn:substring(member.headerMobile, 0, 3)}****${fn:substring(member.headerMobile, 7, 11)}</td>
				</tr>
     		</c:if>
     		
			<c:choose>
				<c:when test="${member.memberMobile == userMobile}">
