...
<body>
		...
		<div style="width: 60%; margin: 0px auto;">
			...
			<c:choose>
				<c:when test="${financialTarget.incrRate > 0 }">
					<div style="text-align: center; line-height: 60px; font-size: 40px; color: #ff5a2c;margin-top: 30px;">${financialTarget.annualizedRates - financialTarget.incrRate}%</div>
					<div style="text-align: center; color: #fe7c4e; border-radius: 15px; border: 1px solid #fe885f; width:70px; left:210px; font-size:12px;position: absolute; top:166px; padding: 1px 0;">加送${financialTarget.incrRate }%</div>
				</c:when>
				<c:otherwise>
					<div style="text-align: center; line-height: 60px; font-size: 40px; color: #ff5a2c;margin-top: 30px;">${financialTarget.annualizedRates }%</div>
				</c:otherwise>
			</c:choose>
	...
	<table class="table2" cellspacing="0" cellpadding="0">
		<tr>
			<td style="border-right: 1px solid #f37b1d;height:30px;vertical-align: middle;"><a href="../financial_description.htm?id=${financialTarget.id }" style="color:#FF7433">项目描述</a></td>
			<td style="vertical-align: middle;"><a href="../financial_buy_history.htm?id=${financialTarget.id }" style="color:#FF7433">投资记录</a></td>
		</tr>
	</table>
