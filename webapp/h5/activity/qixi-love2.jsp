...
<script>
var _malacca = _malacca || [];
_malacca.push(['_setAccount', '1153063038203666432','']);
(function () {
    var mj = document.createElement('script');
    mj.type = 'text/javascript';
    mj.async = true;
    mj.src = 'http://download.inveno.com/SDK/malacca_js/1.1/src/malacca_statis.min.js';
...
<div style="position: relative;">
	<img src="http://laicunba.b0.upaiyun.com/lcb/qixi-bg2.jpg">
	<div id="demo">
<!-- 		<div id="indemo"> -->
...
<!-- 	<div class="hey-no-stop">嗨<br/>不停</div> -->
	<div class="finna-chance"><a href="http://laicunba.b0.upaiyun.com/apk/laicunba_28.apk" id="btn-download" onclick="_malacca.push(['_trackEvent', '软件', '下载', '来存吧', ''])"></a>&nbsp;</div>
	...
	<!-- - 标的链接到相应标的 - --> 
	<a class="model-box" href="javascript:void(0);" style="left: 9%;top: 45%;"></a>
	<a class="model-box" href="javascript:void(0);" style="left: 56%;top: 45%;"></a>
	<a class="model-box" href="javascript:void(0);" style="left: 9%;top: 63%;"></a>
	<a class="model-box" href="javascript:void(0);" style="left: 56%;top: 63%;"></a>
	<a class="model-box-last" href="javascript:void(0);" style="left: 14%;top: 79%;"></a>
	<!-- - 遮罩层 - -->
	<div class="mask"></div>
	<!-- - 活动规则内容 - -->
	<div class="rule-con">
		...
		<div style="text-align: center; margin-bottom: 20px;">活动规则</div>
		<table>
			<tr>
				<td>1、</td>
				<td>活动时间：8.5～8.10</td>
		...
		<table class="data-number" style="margin-top:8px; margin-bottom:8px;" cellpadding="0" cellspacing="0">
			<tr >
...
<!-- 			<a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.example.lcb&ckey=CK1334922178597"><img src="img/invite-btn.png" style="width: 60%;" /></a> -->
<!-- 		</div> -->
	</div>
</div>
