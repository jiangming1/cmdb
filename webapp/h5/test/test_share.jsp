...
<body>
	...
	<a id="sharea" href="test_share_result.jsp?app_view=share&title=分享的标题&url=http://test.laicunba.com/h5/test/test_share_result.jsp&icon=http://test.laicunba.com/h5/img/icon-invite.png&summary=分享的摘要">立即分享</a>
