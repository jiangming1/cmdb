...
<body class="easyui-layout">
	<div data-options="region:'west',split:false" style="width: 40%;">
		<table id="cashCouponDatagrid" class="easyui-datagrid" style="width: 100%; height: 100%;" data-options="rownumbers:true,singleSelect:true,url:'../query.htm?listId=CASH_COUPON_MANAGER.defList&countId=CASH_COUPON_MANAGER.defCount',method:'post',pagination:true,rownumbers:true,fitColumns:true,toolbar:cashCouponDefToolbar">
			<thead>
				<tr>
					<th field="gmt_create" data-options="formatter:dateFormat">创建时间</th>
					<th field="name">名称</th>
					<th field="amount">面额</th>
	...
	<div data-options="region:'center'" style="background-color: white;">
		<table id="tt2" class="easyui-datagrid" style="width: 100%; height: 100%;" data-options="rownumbers:true,singleSelect:true,url:'../query.htm?listId=CASH_COUPON_MANAGER.cashCouponList&countId=CASH_COUPON_MANAGER.cashCouponCount&status=apply',method:'post',pagination:true,rownumbers:true,fitColumns:true,toolbar:cashCouponToolbar">
			<thead>
				<tr>
					...
					<th field="amount">面额</th>
					<th field="used_amount" sortable="true" data-options="styler:usedAmountStyler">已使用</th>
					<th field="conditions">使用条件</th>
					...
					<th field="buy_amount">购买金额(+现金券)</th>
	...
	<script src="cash_coupon_manager.js?v=1"></script>
</body>
</html>