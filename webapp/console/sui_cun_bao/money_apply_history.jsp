...
<script type="text/javascript"
		src="../../static/jquery-easyui-1.4.4/jquery.easyui.min.js"></script>
	<script type="text/javascript"
		src="../../static/jquery-easyui-1.4.4/locale/easyui-lang-zh_CN.js"></script>
<style type="text/css">
.expired {
	color: red;
}
...
<body class="easyui-layout">
	<div data-options="region:'center',split:true" style="background-color: #eee; border: 0px; overflow:hidden;">
		...
		<table id="tt" class="easyui-datagrid" style="width: 100%; height: 95%;" data-options="rownumbers:true,singleSelect:true,url:'../query.htm?listId=FINANCE_OFFICE.withdraw_apply&countId=FINANCE_OFFICE.withdraw_apply_count&status=transfered',method:'post',pagination:false,rownumbers:true,fitColumns:true">
			<thead>
				<tr>
	...
	<script type="text/javascript">
		...
		function doExport(){
			if (confirm("确定要导出excel吗?")) {
				var listId = "FINANCE_OFFICE.withdraw_apply_export";
				var myDate = new Date();
