...
<body class="easyui-layout">
	<div data-options="region:'center',split:true" style="background-color: #eee; border: 0px; overflow:hidden;">
		<div id="tb" style="padding:3px">
			...
			<a href='current_apply.jsp'>查看复利请款单</a>
		</div>
		<table id="tt" class="easyui-datagrid" style="width: 100%; height: 95%;" data-options="rownumbers:true,singleSelect:true,url:'../query.htm?listId=FINANCE_OFFICE.withdraw_apply&countId=FINANCE_OFFICE.withdraw_apply_count&status=apply',method:'post',pagination:false,rownumbers:true,fitColumns:true">
			<thead>
				<tr>
