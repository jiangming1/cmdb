...
<body>
	<table class="table">
		<tr>
			<td style="width: 200px;">用户邀请好友投资发放加息券，并增加积分</td>
			<td>
				<div class="switch switch-large">
					<input class="switchBox" type="checkbox" value="ACT_HALLOWEEN" />
				</div>
				<em>如果开启，在老虎机活动期间（2016-11-14 ~ 2016-11-30），根据用户邀请好友投资的标的（定期理财or新手宝）发放相应的加息券，并增加积分,满100积分时可以参加抽奖活动</em>
			</td>
		</tr>
	</table>
	...
	<script type="text/javascript" src="../../static/bootstrap-switch/docs/js/highlight.js"></script>
	<script type="text/javascript" src="../../static/bootstrap-switch/js/bootstrap-switch.min.js"></script>
				...
				$("input[type=\"checkbox\"]").on('switchChange.bootstrapSwitch', function(event, state) {
					if (state) {
						$.post("../registry_create.htm", {
							t : new Date(),
							id : "act.slot-machines.open",
							value : '[{"start_time":"2016-11-14 00:00:00","end_time":"2016-12-01 00:00:00"}]'
						}, function(rs) {
							if (!rs.success) {
								alert("出错了");
							}
